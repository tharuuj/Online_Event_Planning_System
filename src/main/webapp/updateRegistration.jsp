...
<style>
	...
	<!-- JavaScript function for showing a success message -->
	<script>function showMessage(){
	alert("Your event registration details updated successfully!");
 	}
	</script>
  ...
  <div class="container Details">
    ...
    <h3>Personal Information</h3>
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="first_name" value="<%= fname%>" required>
      </div>
      <div class="form-group col-md-6">
        <span>Last Name:</span>
        <input type="text" class="form-control" name="last_name" value="<%= lname%>" required>
      </div>
      <div class="form-group col-md-6">
        <span>Email:</span>
      ...
      <div class="form-group col-md-6">
        ...
        <select name="event_type" class="form-control" class="event-type-select">       	
      ...
      <div class="form-group col-md-6">
        ...
        <input type="text" class="form-control" name="event_name" value="<%= eventName%>" required>
      </div>
      <div class="form-group col-md-6">
        <span>Date and Time:</span>
        <input type="datetime-local" class="form-control" name="event_date" placeholder="Date and Time" value="<%= date%>" required><br>
      </div>
	<div class="col-md-12">
	<h3>Location Information</h3>
        ...
        <div class="form-group col-md-6">
        <span>Area:</span>
        <select name="area" id="area" class="form-control" onchange="filterHotels()" required>
      ...
      <div class="form-group col-md-6">
        ...
        <select name="guest_count" id="guest_count" class="form-control" onchange="filterHotels()" required>
      ...
      <div class="form-group col-md-6">
    	<span>Hotel:</span>
    	<select name="hotel" id="hotel" class="form-control" value="<%= hotelName%>">
        	<option value="" disabled selected>Select the hotel</option>
    	</select>
	  </div>
      <div class="form-group col-md-6">
        <span>Comments:</span>
        <input type="text" name="comments" class="form-control" value="<%= comments%>">
      </div>

	<!-- Submit button with an onclick event to show the success message -->
	<input type="submit" value="Update" class="submit-button form-control btn btn-danger" name="submit" onclick="showMessage()">
  
    </form>
  </div>
  
  
 <!-- Javascript to dynamically filter the hotels -->
  <script>
