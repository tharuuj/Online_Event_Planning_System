...
<head>
    ...
    <title>Event Planning System Signin</title>
     <!-- Style Css Link -->
...
<li class="dropdown"> <!-- Dropdown Menu -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="center-text"><a href="#">Hotels</a></li>
...
<style>
   body {
            ...
            background-image: url("css/images/signin.jpg");
    ...
    <div class="container">
        <h1>Sign in</h1>
        <form id="signinForm" action="useraccount.jsp" method="post">
